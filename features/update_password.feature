...
Feature: Set Password
  Scenario: Update password for a new User
    ...
    When I access endpoint "/users/updatePassword?email=test3@tamu.edu" and enter a valid email "test3@tamu.edu"("Test User3"), password "abcd@1234567" and re-password "abcd@1234567"
